    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <a href="gendebates.xhtml">Return to All General Debates</a>
                <hr/>
                <div class="container">
                    <div class="debate">
                    ...
                    <div class="debateMenu">
                        ...
                        <input type="checkbox" id="immigrantCheck" name="keyword" value="immigrant"/><label for="immigrationCheck">Immigration</label><br/>
